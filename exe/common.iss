...
#define NGINX_OPENSSL_ENV 'openssl\openssl.conf'
...
Filename: "{#REPLACE}"; Parameters: """DsConverterSvc"" ""{#CONVERTER_SRV}"" ""{#CONVERTER_SRV_FILE}"""; Flags: runhidden; StatusMsg: "{cm:CfgSrv,{#CONVERTER_SRV}}"
Filename: "{#REPLACE}"; Parameters: """DsConverterSvc_Display"" ""{#CONVERTER_SRV_DISPLAY}"" ""{#CONVERTER_SRV_FILE}"""; Flags: runhidden; StatusMsg: "{cm:CfgSrv,{#CONVERTER_SRV}}"
Filename: "{#REPLACE}"; Parameters: """DsConverterSvc_Descr"" ""{#CONVERTER_SRV_DESCR}"" ""{#CONVERTER_SRV_FILE}"""; Flags: runhidden; StatusMsg: "{cm:CfgSrv,{#CONVERTER_SRV}}"
...
Filename: "{#REPLACE}"; Parameters: """DsDocServiceSvc"" ""{#DOCSERVICE_SRV}"" ""{#DOCSERVICE_SRV_FILE}"""; Flags: runhidden; StatusMsg: "{cm:CfgSrv,{#DOCSERVICE_SRV}}"
Filename: "{#REPLACE}"; Parameters: """DsDocServiceSvc_Display"" ""{#DOCSERVICE_SRV_DISPLAY}"" ""{#DOCSERVICE_SRV_FILE}"""; Flags: runhidden; StatusMsg: "{cm:CfgSrv,{#DOCSERVICE_SRV}}"
Filename: "{#REPLACE}"; Parameters: """DsDocServiceSvc_Descr"" ""{#DOCSERVICE_SRV_DESCR}"" ""{#DOCSERVICE_SRV_FILE}"""; Flags: runhidden; StatusMsg: "{cm:CfgSrv,{#DOCSERVICE_SRV}}"
...
Filename: "{#REPLACE}"; Parameters: """DsProxySvc"" ""{#NGINX_SRV}"" ""{#PROXY_SRV_FILE}"""; Flags: runhidden; StatusMsg: "{cm:CfgSrv,{#NGINX_SRV}}"
Filename: "{#REPLACE}"; Parameters: """DsProxySvc_Display"" ""{#NGINX_SRV_DISPLAY}"" ""{#PROXY_SRV_FILE}"""; Flags: runhidden; StatusMsg: "{cm:CfgSrv,{#NGINX_SRV}}"
