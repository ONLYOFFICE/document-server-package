...
### BEGIN INIT INFO
# Provides:          ds-converter
# Required-Stop:     $remote_fs $network $named
# Required-Stop:	 $remote_fs $network $named
# Default-Start:     2 3 5
# Default-Stop:		 0 1 6
# Short-Description: Docs Converter
### END INIT INFO

PATH=/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin

DAEMON="/var/www/M4_DS_PREFIX/server/FileConverter/converter"
DAEMON_ARGS="NODE_ENV=production-linux NODE_CONFIG_DIR=/etc/M4_DS_PREFIX NODE_DISABLE_COLORS=1 APPLICATION_NAME=M4_COMPANY_NAME"
LOG_DIR="/var/log/M4_DS_PREFIX/converter"
NAME="ds-converter"
DESC="Docs Converter"
USER="ds"
...
start_ds() {
		...
		if [ ${RETVAL} != 0 ] ; then
			...
			--startas /bin/bash -- -c "${DAEMON_ARGS} exec ${DAEMON} \
