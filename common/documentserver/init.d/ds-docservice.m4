...
### BEGIN INIT INFO
# Provides:			ds-docservice
# Required-Stop:		$remote_fs $network $named
# Required-Stop:		$remote_fs $network $named
# Default-Start:		2 3 5
# Default-Stop:		0 1 6
# Short-Description:	Docs Docservice
### END INIT INFO

PATH=/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin

DAEMON="/var/www/M4_DS_PREFIX/server/DocService/docservice"
DAEMON_ARGS="NODE_ENV=production-linux NODE_CONFIG_DIR=/etc/M4_DS_PREFIX NODE_DISABLE_COLORS=1"
LOG_DIR="/var/log/M4_DS_PREFIX/docservice"
NAME="ds-docservice"
DESC="Docs Docservice"
USER="ds"
