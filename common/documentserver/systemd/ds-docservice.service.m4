...
ExecStart=/bin/sh -c '/var/www/M4_DS_PREFIX/server/DocService/docservice >>/var/log/M4_DS_PREFIX/docservice/out.log 2>>/var/log/M4_DS_PREFIX/docservice/err.log'
