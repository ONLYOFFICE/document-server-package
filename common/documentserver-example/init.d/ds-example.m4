...
DAEMON="/var/www/M4_DS_PREFIX-example/example"
DAEMON_ARGS="NODE_ENV=production-linux NODE_CONFIG_DIR=/etc/M4_DS_PREFIX-example NODE_DISABLE_COLORS=1"
LOG_DIR="/var/log/M4_DS_PREFIX-example"
NAME="ds-example"
DESC="Docs Example"
USER="ds"
