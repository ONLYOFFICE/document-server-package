...
## Running Docker Image
    ...
    sudo docker run -i -t -d -p 80:80 onlyoffice/documentserver-enterprise
...
To get access to your data from outside the container, you need to mount the volumes. It can be done by specifying the '-v' option in the docker run command.
    ...
    sudo docker run -i -t -d -p 80:80 \
        ...
        -v /opt/onlyoffice/Data:/var/www/onlyoffice/Data  onlyoffice/documentserver-enterprise
...
To change the port, use the -p command. E.g.: to make your portal accessible via port 8080 execute the following command:
    ...
    sudo docker run -i -t -d -p 8080:80 onlyoffice/documentserver-enterprise
...
```bash
sudo docker run -i -t -d  --name onlyoffice-document-server onlyoffice/documentserver-enterprise
```
